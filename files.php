			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						?>
							<li class="breadcrumb-item text-dark"><?php echo $path['name']; ?></li>
						<?php
							$id = $path['parent_id'];
						}
						?>
						<li class="breadcrumb-item"><a href="index.php?page=files_list">Files</a></li>
						<li class="breadcrumb-item active"><a class="text-dark" href="index.php?page=files">Files</a></li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
		...
		<div class="container-fluid">
			<div class="col-lg-12">
				...
				<button class="btn btn-success btn-sm" id="new_folder"><i class="fa fa-plus"></i> New Folder</button>
					<button class="btn btn-secondary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Upload File</button>
				</div>
				<div class="col-sm-6">
				<div class="input-group input-group-sm float-sm-right" style="width: 300px;">
						<input type="text" name="table_search" id="search" class="form-control float-right" aria-describedby="inputGroup-sizing-sm" placeholder="Search">
					...
					<div class="col-12">
						<div class="card">
							...
							<div class="row p-3">
								...
								?>
									<div class="card col-md-3 m-2 folder-item elevation-2" data-id="<?php echo $row['id'] ?>">
										<div class="card-body">
											<large><span><i class="fa fa-folder mr-2"></i></span><b class="to_folder"> <?php echo $row['name'] ?></b></large>
										</div>
									</div>
								<?php endwhile; ?>
							</div>
									...
									<tbody>
										...
										?>
											<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
												<td>
													<large><span><i class="fa <?php echo $icon ?> mr-2"></i></span><b class="to_file"> <?php echo $name ?></b></large>
