...
<head>
  ...
  <title>File & Task Management System</title>
...
<body>
  ...
  <main id="main" class="alert-dark">
  		<div id="login-left" class="bg-dark">
  			<div class="logo">
  				<img class="img-fluid" src="assets/ronaldlogoLogin.png">
  			</div>
  		</div>
  		<div id="login-right">
  			<div class="w-100">
  				<h4 class="text-dark text-center mx-3"><b>File and Task Management System</b></h4>
  				<br>
